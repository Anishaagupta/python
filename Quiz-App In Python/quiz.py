...
def difficult():
    ...
    submit.place(relx=0.2,rely=0.70,anchor=CENTER)
    
    nextQuestion = Button(hard_frame,command=display,text="Next")
    nextQuestion.place(relx=0.75,rely=0.70,anchor=CENTER)
...
def start():
    ...
    button.configure(width = 50,height=2, activebackground = "#33B5E5", relief = RAISED)
